...
pytestmark = pytest.mark.international
...
def test_introspection(client_query):
    response = client_query(
        ...
        query {
            ...
            pnType: __type(name: "PhoneNumber") {
                name
                kind
                description
            }
    ...
    assert content["data"] == {
        "upType": {
            "fields": [
                ...
                {"name": "phoneNumber", "type": {"ofType": {"name": "PhoneNumber"}}},
            ]
        },
        "pnType": {
            "name": "PhoneNumber",
            "kind": "SCALAR",
            "description": "An international phone number, formatted using the E.164 standard.",
        },
    }
